  ...
  return [
    {
      ...
      create() {
        ...
        dom.className =
          "bg-popover text-popover-foreground z-50 rounded-sm border-input p-1 shadow-md flex items-center gap-2 text-sm";

        const addToChatButton = document.createElement("button");
        addToChatButton.textContent = "Add to Chat";
        addToChatButton.className =
          "font-sans px-2 hover:foreground/10 rounded-sm";

        const quickEditButton = document.createElement("button");
        quickEditButton.className =
          "font-sans p-1 px-2 hover:foreground/10 rounded-sm items-center gap-1";
